...
class PiApplication(object):
    ...
    def __init__(self, config):
        ...
        self.state_machine.add_state(StateWait(self.config.getfloat('WINDOW', 'animate_delay')))
        ...
        self.state_machine.add_state(StatePrint(self.config.getfloat('PRINTER', 'printer_delay')))
